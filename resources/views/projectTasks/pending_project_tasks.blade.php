...
@endunless
@section('title','Lopende project taaken')
@section('style')
    <style>
        body {
    ...
    <div class="grid-container">
        <div class="my-3 my-md-5">
            <div class="page-header">
                <h1 class="page-title">Lopende project taaken</h1>
            </div>
                                        ...
                                        <td>
                                            @if($pending->status=='pending')
                                                <a href="" class="btn btn-success" onclick="alert
                                                    ...
                                                    ">Markeer als klaar</a>
                                            @endif
                                            <a href="{{route('project_task.edit',$pending->id)}}" class="btn btn-info">Bewerken</a>
