...
class TaskController extends Controller
{
    ...
    {
        $all_tasks=Tasks::all();
        return view('tasks.tasks',['tasks'=>$all_tasks]);
    }

    // show all pending tasks
    public function pending(){
        $pending_task=Tasks::where('status','pending')->get();
        return view('tasks.pending_tasks',['pendings'=>$pending_task]);
    }

    // show all completed tasks
    public function completed(){
        $completed_task=Tasks::where('status','completed')->get();
        return view('tasks.completed_tasks',['completed'=>$completed_task]);
    }
    ...
    public function create()
    {
        ...
        return view('tasks.add_task',['categories'=>$all_categories,'count'=>$count_categories]);
    }
